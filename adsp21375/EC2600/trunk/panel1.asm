...
.var switch_jump_table[] =
		0x0b7e, MUTE_IN0,			// MAX7301 P24
		0x0b7d, MUTE_IN1,			// MAX7301 P25
		0x0b7b, MUTE_OUT0,			// MAX7301 P26
		0x0b77, MUTE_OUT1,			// MAX7301 P27
		0x0b6f, MUTE_OUT2,			// MAX7301 P28
		0x0b5f, MUTE_OUT3,			// MAX7301 P29
		0x0b3f, MUTE_OUT4,			// MAX7301 P30
		0x0e6f, MUTE_OUT5,
		0x0e7e, SWITCH_DOWN,
		0x0e7d, SWITCH_UP,
		0x0e7b, SWITCH_DISP,
...
_default_program_invalid:
	...
	r0 = 0x40fe;						// preset UN-LOCK. program indicator
...
_keyProcessing:
	...
	lcntr = @switch_jump_table/2, do (pc, 3) until lce;
		r10 = dm(i4, m6);
		comp(r8, r10), modify(i4, m6);
