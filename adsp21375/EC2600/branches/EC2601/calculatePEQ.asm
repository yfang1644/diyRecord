...
.extern ___float_divide, _sqrtf, _sinf, _cosf, _expf, _exp_dB;
...
_calculatePEQ:
	...
	r3 = 24;
	r2 = r2 - r3, puts = r4;
	f12 = 2.30258509299404590109/80.0;	// ln(10.0)/80, 0.5dB/step
										// only for Peaking and Shelv
	f4 = FLOAT r2,
	CCALL (_exp_dB + 1);
	dm(A) = f0;
