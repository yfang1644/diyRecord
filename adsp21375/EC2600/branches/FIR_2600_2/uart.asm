...
.extern _convertHexToPhase, _adjustPreWrap, _calculateFIR;
.extern _loadFromFlash, _smoothPhase;
...
uart_P:									// Program Data Set(for current program)
	...
	m3  = r0;
	call (pc, _convertHexToPhase);		// r0=channel, unchanged in this func.
	m3  = r0;
	call (pc, _adjustPreWrap);			// r0=channel, unchanged in this func.
	r4  = r0;
...
uart_L:
	...
	r4  = 0x30;							// '0'=no_error
	if NE jump (pc, invalidL), r4 = r4 + 1;	// invalid flash data, '1'
	m3  = r0;
	call (pc, _adjustPreWrap);			// r0=channel, unchanged in this func.
	r4  = r0;
	call (pc, _calculateFIR);			// r4=channel
